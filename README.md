...
![npm](https://img.shields.io/npm/v/ai-bundle-check)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-bundle-check)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Bundle analysis and optimization tool for modern web applications

Bundle analysis and optimization tool. Identifies large dependencies and suggests alternatives.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-bundle-check.svg)](https://badge.fury.io/js/ai-bundle-check)
